...
const i18n = {
  "en": {
    ...
    "spellDescriptions": {
      ...
      "Fel Immolate": "Single-target Fire hit followed by a Fire DoT.",
      "Curse of Agony": "Curse DoT that ramps upward over time. Decurse.",
      "Sonic Strike": "35 yd frontal cone silence for 5 sec. Face away from raid.",
      "Cloak of Shadows": "Temporary spell resistance window. Avoid wasting key spells.",
      "Shadowstep": "Teleports directly to its target.",
      "Curse of the Bleakheart": "3 min Curse causing periodic stuns. Decurse fast.",
      "Rapid Shot": "Channeled rapid ranged attack; stop with incap effects such as Gouge or grenades.",
      "Skeleton Shot": "Heavy Shadow hit plus DoT; can spawn Fallen Ally if the target dies.",
      "Concussion Blow": "Tank stun for 5 sec. Threat generation is compromised.",
      "Charge Frenzy": "Feral Spirit frenzy that charges random targets every 2 sec.",
      "Spirit Bond": "Large self-heal over time on Feral Spirit.",
      "Chain Heal": "Large heal that jumps to nearby allies. Interrupt/stop.",
      "Bloodlust": "Hostile attack/cast speed buff. Dispel and kill Windfury Totem.",
      "Searing Totem": "Summoned totem that shoots heavy Fire damage.",
      "Summon Windfury Totem": "Summons Windfury Totem for nearby enemies. Kill instantly.",
      "Wyvern Sting": "Sleeps a random target, then applies a Nature DoT.",
      "Multi-Shot": "Hard-hitting ranged attack on up to 3 targets.",
      "Sweeping Wing Clip": "Immobilizes nearby players for 10 sec.",
      "Lightning Cloud": "Nature ground AoE. Move out and reposition pack.",
      "Fear": "AoE fear risk. Use fear protection and pull in a safe spot.",
      "Chaotic Light": "Nasty frontal Shadow cone. Face away from raid.",
      "Whirling Blade": "Summoned blade hazard that spins and damages nearby players.",
      "Freezing Trap": "20 yd magic root for 30 sec. Dispel.",
      "Silencing Shot": "Random physical hit plus 3 sec silence.",
      "Wing Clip": "Melee slow.",
      "Carnivorous Bite": "Bleed applied by Shadowmoon Riding Hounds.",
      "Spell Absorption": "Absorbs magic effects and later detonates Chaotic Charges. Stop feeding spells into it.",
    ...
    "ui": {
      ...
      "spells": "Spells",
      "copy": "Copy",
      "unknownSpell": "Spell effect noted on this mob.",
  ...
  "fr": {
    ...
    "ui": {
      ...
      "spells": "Sorts",
      "copy": "Copier",
      "unknownSpell": "Effet de sort présent sur ce mob.",
...
const supplementalSpellDescriptions = {
  en: {
    "Anti-Magic Shell": "Huge magic absorb on the Banshee. Swap physical damage or wait it out.",
    "Banshee Curse": "Long curse that cripples physical hit chance. Decurse physical DPS quickly.",
    "Banshee Wail": "Single-target Shadow ranged attack from Banshees.",
    "Behemoth Charge": "Charge damage and movement disruption. Keep the target stable.",
    "Blind": "Poison disable. Dispel poison or cover the controlled player.",
    "Bloodbolt": "Shadow cast that also slows the target.",
    "Booming Voice": "Buff/support shout. Treat the caster as a quick control or kill target.",
    "Cloud of Disease": "Disease cloud around the mob. Keep melee exposure low and cleanse when needed.",
    "Crashing Wave": "Water splash/knock pressure from Aqueous Lord. Face and position cleanly.",
    "Curse of Vitality": "Shadow DoT curse. Decurse or heal through until it falls off.",
    "Debilitating Spray": "Frontal spray that weakens targets. Face away from raid.",
    "Dementia": "Split/illusion mechanic. Be ready to pick up the images.",
    "Disease Cloud": "Persistent Nature damage around Abominations. Melee/tanks watch range.",
    "Divine Shield": "Temporary immunity. Swap targets or wait it out.",
    "Fel Stomp": "AoE stomp around the Behemoth. Melee/tank damage spike.",
    "Flamestrike": "Fire ground AoE. Move out.",
    "Free Friend": "Support ability that frees or helps an ally. Stop/kill the caster quickly.",
    "Frost Breath": "Frost cone/splash that damages and slows. Spread around the target.",
    "Gargoyle Strike": "Long-range Nature shot from airborne Gargoyles.",
    "Harpooner's Mark": "Mark that directs the turtle/pack pressure onto a target. Dispel if possible.",
    "Hooked Net": "Root/snare on a player. Free the target or cover them.",
    "Image of Dementia": "Spawned image from Dementia split. Pick up and cleave down.",
    "Immolation": "Fire aura around the mob. Tank/melee damage over time.",
    "Instant Poison": "Extra Nature damage on melee swings.",
    "Judgement of Command": "Paladin-style Holy burst on the target.",
    "Knockdown": "Short stun and physical hit on the tank.",
    "L1 Arcane Charge": "Low-level Arcane charge from Promenade Sentinel. Keep moving/handling clean.",
    "L5 Arcane Charge": "High-level Arcane charge. Treat as lethal and protect the target.",
    "Lash of Pain": "Quick Shadow damage hit from succubus trash.",
    "Lightning Prod": "Lightning poke/chain pressure from Coilskar Wrangler. Spread if needed.",
    "Meteor": "Shared Fire impact. Stack to split damage when called.",
    "Mind Soothe": "Priest utility used to reduce pull radius and enable skips.",
    "Mind-numbing Poison": "Poison that slows casting. Dispel poison on casters/healers.",
    "Painful Rage": "Reflective/enrage window. Stop or swap if the mob is punishing damage.",
    "Paralyzing Poison": "Poison control effect. Dispel quickly.",
    "Poison Spit": "Nature ranged hit. Heal through and avoid extra cleave positioning.",
    "Power Word: Shield": "Absorb shield. Purge/dispel or keep pressure through it.",
    "Prophecy of Blood": "Debuff that increases damage taken. Cover the target.",
    "Riposte": "Counterattack/disarm-style melee response. Tanks/melee watch weapon control.",
    "Shadow Word: Pain": "Shadow DoT. Dispel or heal through.",
    "Shared Bonds": "Linked damage between paired mobs. Cleave them together.",
    "Shell Shield": "Defensive shell. Slow damage or control until it drops.",
    "Shield Bash": "Melee interrupt/silence. Casters stay away from the mob.",
    "Shield Wall": "Major defensive cooldown. Swap or keep steady pressure.",
    "Spear Throw": "Ranged physical hit from Harpooner.",
    "Tail Sweep": "Rear cone knockback/damage. Do not stand behind.",
    "Throw Shield": "Ranged shield throw. Spread/cover the hit target.",
    "Unholy Frenzy": "Attack speed buff on another mob. Dispel/stop and kill the caster.",
    "Vanish": "Mob disappears briefly and may retarget. Tanks be ready to re-pickup.",
    "Vile Slime": "Nature/slime damage. Avoid stacking unnecessary raid damage.",
    "Water Spit": "Ranged Frost/Water hit from turtle-type trash."
  },
  fr: {
    "Anti-Magic Shell": "Gros bouclier anti-magie sur la Banshee. Passer en dégâts physiques ou attendre.",
    "Banshee Curse": "Malédiction longue qui détruit le toucher physique. Decurse vite les physiques.",
    "Banshee Wail": "Attaque Ombre à distance sur une cible.",
    "Behemoth Charge": "Charge avec dégâts et déplacement. Stabiliser la cible.",
    "Blind": "Contrôle poison. Dispel poison ou couvrir le joueur contrôlé.",
    "Bloodbolt": "Cast Ombre qui ralentit la cible.",
    "Bloodlust": "Buff hostile de vitesse attaque/cast. Dispel et tuer le totem Windfury.",
    "Booming Voice": "Cri/buff de support. Contrôler ou tuer le caster rapidement.",
    "Carnivorous Bite": "Morsure avec saignement du Riding Hound.",
    "Chain Heal": "Gros heal qui rebondit sur les alliés proches. À interrompre.",
    "Chaotic Light": "Cône Ombre frontal dangereux. Face loin du raid.",
    "Charge Frenzy": "Frenzy du Feral Spirit avec charges répétées sur des cibles aléatoires.",
    "Cloak of Shadows": "Fenêtre de résistance magie. Ne pas gaspiller les gros sorts dedans.",
    "Cloud of Disease": "Nuage de maladie autour du mob. Limiter l'exposition mêlée et cleanse si besoin.",
    "Concussion Blow": "Stun tank de 5 sec. Menace et dégâts tank à surveiller.",
    "Crashing Wave": "Vague/eau avec pression et possible knock. Placement propre.",
    "Curse of Agony": "Malédiction DoT qui monte en dégâts. Decurse.",
    "Curse of Vitality": "Malédiction DoT Ombre. Decurse ou heal jusqu'à expiration.",
    "Curse of the Bleakheart": "Malédiction longue avec stuns périodiques. Decurse vite.",
    "Debilitating Spray": "Spray frontal qui affaiblit les cibles. Face loin du raid.",
    "Dementia": "Mécanique de split/images. Préparer pickup et cleave.",
    "Disease Cloud": "Aura Nature persistante autour des Abominations. Attention tanks/mêlées.",
    "Divine Shield": "Immunité temporaire. Swap cible ou attendre.",
    "Doom Blast": "Explosion Ombre autour de la cible du Doom Bolt. S'écarter.",
    "Doom Bolt": "Projectile Ombre qui provoque un splash autour de la cible.",
    "Fear": "Fear de zone. Tremor/Fear Ward et pull dans une zone sûre.",
    "Fel Immolate": "Hit Feu puis DoT Feu sur la cible.",
    "Fel Stomp": "Stomp AoE autour du Behemoth. Pic de dégâts tank/mêlée.",
    "Felfire": "Proc Feu en mêlée du Wyrmcaller.",
    "Flamestrike": "Zone feu au sol. Sortir.",
    "Forked Lightning": "Attaque Nature frontale jusqu'à plusieurs cibles. Face propre/spread.",
    "Free Friend": "Sort de support qui aide/libère un allié. Stop ou tuer le caster.",
    "Freeze": "Root givre en zone. Dispel/tenir les cibles coincées.",
    "Freezing Trap": "Root magique de zone. Dispel les joueurs bloqués.",
    "Frost Breath": "Souffle givre qui touche et ralentit autour de la cible. Spread.",
    "Fury": "Buff du Taskmaster qui augmente taille et dégâts.",
    "Gargoyle Strike": "Tir Nature longue portée des Gargoyles en l'air.",
    "Geyser": "Splash givre + projection sur cible aléatoire. S'écarter.",
    "Harpooner's Mark": "Marque qui dirige la pression/tortue sur une cible. Dispel si possible.",
    "Hooked Net": "Root/snare sur joueur. Libérer ou couvrir la cible.",
    "Hurricane": "AoE nature au sol placée sur un joueur. Bouger vite.",
    "Illidari Flames": "Cône Feu frontal par seconde. Face loin du raid.",
    "Image of Dementia": "Image créée par le split de Dementia. Pickup et cleave.",
    "Immolation": "Aura Feu autour du mob. Dégâts réguliers sur tank/mêlées.",
    "Immolation Arrow": "Flèche Feu qui laisse une zone brûlante au sol.",
    "Instant Poison": "Dégâts Nature ajoutés aux attaques mêlée.",
    "Jab": "Coup mêlée sur la cible principale avec knockback.",
    "Judgement of Command": "Burst sacré type paladin sur la cible.",
    "Knockdown": "Court stun + dégâts physiques sur le tank.",
    "L1 Arcane Charge": "Charge arcanes faible du Promenade Sentinel. Garder le handling propre.",
    "L5 Arcane Charge": "Charge arcanes haute. Traiter comme létal et protéger la cible.",
    "Lash of Pain": "Coup Ombre rapide des succubes.",
    "Lightning Cloud": "Zone Nature au sol. Bouger et replacer le pack.",
    "Lightning Prod": "Pression lightning du Coilskar Wrangler. S'écarter si besoin.",
    "Merge": "Canalisation qui soigne l'Aqueous Lord si le Spawn survit trop longtemps.",
    "Meteor": "Impact Feu partagé. Stack pour répartir quand c'est call.",
    "Mind Soothe": "Utilitaire prêtre pour réduire l'aggro range et permettre les skips.",
    "Mind-numbing Poison": "Poison qui ralentit les casts. Dispel sur casters/healers.",
    "Multi-Shot": "Tir physique fort sur plusieurs cibles.",
    "Painful Rage": "Fenêtre reflect/enrage. Stop ou swap si le mob punit les dégâts.",
    "Paralyzing Poison": "Contrôle poison. Dispel vite.",
    "Poison Spit": "Hit Nature à distance. Heal et éviter le placement sale.",
    "Power Word: Shield": "Bouclier absorb. Purge/dispel ou continuer la pression.",
    "Prophecy of Blood": "Debuff qui augmente les dégâts subis. Couvrir la cible.",
    "Rain of Chaos": "AoE Feu au sol sur position joueur. Sortir.",
    "Rapid Shot": "Canalisation de tirs rapides. Stop avec incap si possible.",
    "Riposte": "Réponse mêlée type contre/désarmement. Tanks/mêlées attentifs.",
    "Searing Totem": "Totem qui tire de gros dégâts Feu. Tuer vite.",
    "Shadow Word: Pain": "DoT Ombre. Dispel ou heal.",
    "Shadowstep": "Téléportation instantanée sur la cible.",
    "Shared Bonds": "Dégâts liés entre deux mobs. Les garder ensemble et cleave.",
    "Shell Shield": "Bouclier défensif. Ralentir les dégâts ou contrôler jusqu'à la fin.",
    "Shield Bash": "Interrupt/silence mêlée. Casters loin du mob.",
    "Shield Wall": "Gros cooldown défensif. Swap ou maintenir pression stable.",
    "Silencing Shot": "Tir sur cible aléatoire avec silence court.",
    "Skeleton Shot": "Gros hit Ombre + DoT; peut créer un add si la cible meurt.",
    "Sludge Nova": "AoE Nature autour de la cible avec DoT stack et slow.",
    "Sonic Strike": "Cône frontal silence. Face loin du raid.",
    "Spear Throw": "Hit physique à distance du Harpooner.",
    "Spell Absorption": "Absorbe les effets magiques puis explose en charges. Stop magie dedans.",
    "Spirit Bond": "Gros soin sur la durée du Feral Spirit.",
    "Summon Windfury Totem": "Invoque un totem Windfury pour les ennemis proches. Tuer instant.",
    "Sweeping Wing Clip": "Immobilise les joueurs proches. Mêlées attention.",
    "Tail Sweep": "Cône arrière avec knock/dégâts. Ne pas rester derrière.",
    "Throbbing Stun": "Stun court déclenché par Throw Pick.",
    "Throw Pick": "Lancer de pioche à distance qui stun la cible.",
    "Throw Shield": "Lancer de bouclier à distance. Couvrir la cible touchée.",
    "Unholy Frenzy": "Buff vitesse d'attaque sur un autre mob. Dispel/stop et tuer le caster.",
    "Vanish": "Le mob disparaît brièvement et peut retarget. Tank prêt à reprendre.",
    "Vile Slime": "Dégâts Nature/slime. Éviter les dégâts raid gratuits.",
    "War Stomp": "Stun + dégâts courte portée autour du caster.",
    "Water Spit": "Hit eau/givre à distance des trashs type tortue.",
    "Whirling Blade": "Lame invoquée qui tourne et blesse les joueurs proches.",
    "Wing Clip": "Slow mêlée.",
    "Wyvern Sting": "Sleep puis DoT Nature sur cible aléatoire."
  }
};

Object.assign(i18n.en.spellDescriptions, supplementalSpellDescriptions.en);
Object.assign(i18n.fr.spellDescriptions, supplementalSpellDescriptions.fr);
...
const trashImages = {
  ...
  "Coilskar Soothsayer": "assets/TrashBT_generated/34_coilskar_soothsayer.png",
  "Illidari Defiler": "assets/TrashBT_generated/35_illidari_defiler.png",
  "Illidari Centurion": "assets/TrashBT_generated/36_illidari_centurion.png",
  "Illidari Boneslicer": "assets/TrashBT_generated/37_illidari_boneslicer.png",
  "Illidari Heartseeker": "assets/TrashBT_generated/38_illidari_heartseeker.png",
  "Ashtongue Battlelord": "assets/TrashBT_generated/39_ashtongue_battlelord.png",
  "Ashtongue Feral Spirit": "assets/TrashBT_generated/40_ashtongue_feral_spirit.png",
  "Ashtongue Mystic": "assets/TrashBT_generated/41_ashtongue_mystic.png",
  "Ashtongue Primalist": "assets/TrashBT_generated/42_ashtongue_primalist.png",
  "Ashtongue Stormcaller": "assets/TrashBT_generated/43_ashtongue_stormcaller.png",
  "Ashtongue Stalker": "assets/TrashBT_generated/44_ashtongue_stalker.png",
  "Storm Fury": "assets/TrashBT_generated/45_storm_fury.png",
  "Illidari Nightlord": "assets/TrashBT_generated/46_illidari_nightlord.png",
  "Shadowmoon Champion": "assets/TrashBT_generated/47_shadowmoon_champion.png",
  "Shadowmoon Houndmaster": "assets/TrashBT_generated/48_shadowmoon_houndmaster.png",
  "Shadowmoon Riding Hound": "assets/TrashBT_generated/49_shadowmoon_riding_hound.png",
  "Shadowmoon Reaver": "assets/TrashBT_generated/50_shadowmoon_reaver.png",
  "Shadowmoon Weapon Master": "assets/TrashBT_generated/51_shadowmoon_weapon_master.png",
  "Wrathbone Flayer": "assets/TrashBT_generated/52_wrathbone_flayer.png",
  "Bonechewer Brawler": "assets/TrashBT_generated/53_bonechewer_brawler.png",
  "Bonechewer Combatant": "assets/TrashBT_generated/54_bonechewer_combatant.png",
  "Bonechewer Spectator": "assets/TrashBT_generated/55_bonechewer_spectator.png",
  "Priestess of Delight": "assets/TrashBT_generated/56_priestess_of_delight.png",
  "Ardent Host": "assets/TrashBT_generated/57_ardent_host.png",
  "Devoted Steward": "assets/TrashBT_generated/58_devoted_steward.png",
  "Temple Acolyte": "assets/TrashBT_generated/59_temple_acolyte.png",
  "Charming Patron": "assets/TrashBT_generated/60_charming_patron.png"
};
...
const trashData = [
  ...
  },
  {
    ...
    "mob": "Illidari Defiler",
    "priority": "red",
    "markers": ["skull"],
    "tags": ["focus", "aoe", "dispel", "ranged"],
    "danger": "Rain of Chaos ticks hard; Fel Immolate DoT; Curse of Agony ramps; Banish disables a random raider for 15 sec.",
    "call": "FOCUS Defiler; move Rain; decurse Agony.",
    "tank": "Group only when ground AoE is under control. Watch random-player Banish.",
    "spells": [["Rain of Chaos", "assets/spell_shadow_rainoffire.jpg"], ["Fel Immolate", "assets/spell_fire_felhellfire.jpg"], ["Curse of Agony", "assets/spell_shadow_shadowbolt.jpg"], ["Banish", "assets/spell_shadow_cripple.jpg"]]
  },
  {
    "raid": "BT",
    "zone": "Akama / Sanctuary",
    "mob": "Illidari Centurion",
    "priority": "red",
    "markers": ["cross"],
    "tags": ["tank", "cleave", "ranged"],
    "danger": "Sonic Strike is a 35 yd frontal cone silence for 5 sec; also has Cleave.",
    "call": "FACE Centurion away; never frontal raid.",
    "tank": "Do not point Sonic Strike at raid. Avoid Paladin tank if silence is causing pickup issues.",
    "spells": [["Sonic Strike", "assets/spell_holy_silence.jpg"], ["Cleave", "assets/ability_warrior_cleave.jpg"]]
  },
  {
    "raid": "BT",
    "zone": "Akama / Sanctuary",
    "mob": "Illidari Boneslicer",
    "priority": "orange",
    "markers": ["moon"],
    "tags": ["banish", "stopcc", "tank"],
    "danger": "AoE Gouge incapacitates players within 8 yd; Cloak of Shadows resists spells; Shadowstep teleports to target.",
    "call": "BANISH/stop Boneslicer; melee watch Gouge.",
    "tank": "Expect target jumps with Shadowstep and spell-resistant windows during Cloak.",
    "spells": [["Gouge", "assets/ability_gouge.jpg"], ["Cloak of Shadows", "assets/spell_shadow_impphaseshift.jpg"], ["Shadowstep", "assets/spell_shadow_teleport.jpg"]]
  },
  {
    "raid": "BT",
    "zone": "Akama / Sanctuary",
    "mob": "Illidari Heartseeker",
    "priority": "red",
    "markers": ["triangle"],
    "tags": ["banish", "stopcc", "dispel", "ranged"],
    "danger": "Curse of the Bleakheart causes periodic stuns and is decursable; Rapid Shot must be stopped by incap; Skeleton Shot can spawn Fallen Ally if target dies.",
    "call": "BANISH small demons; DECURSE; Gouge/incap Rapid Shot.",
    "tank": "Keep controlled; assign decurse and incap stops so Skeleton Shot/Rapid Shot do not snowball.",
    "spells": [["Curse of the Bleakheart", "assets/spell_shadow_cripple.jpg"], ["Rapid Shot", "assets/ability_marksmanship.jpg"], ["Skeleton Shot", "assets/spell_shadow_shadowbolt.jpg"]]
  },
  {
    "raid": "BT",
    "zone": "Akama / Sanctuary",
    "mob": "Ashtongue Battlelord",
    "priority": "orange",
    "markers": ["square"],
    "tags": ["tank", "cleave", "stun"],
    "danger": "Frontal Cleave; Concussion Blow stuns tank for 5 sec; Enrage increases damage and attack speed.",
    "call": "FACE Battlelord away; watch tank stun/enrage.",
    "tank": "Threat drops during Concussion Blow are dangerous; face away and stabilize during Enrage.",
    "spells": [["Cleave", "assets/ability_warrior_cleave.jpg"], ["Concussion Blow", "assets/ability_gouge.jpg"], ["Enrage", "assets/spell_shadow_unholyfrenzy.jpg"]]
  },
  {
    "raid": "BT",
    "zone": "Akama / Sanctuary",
    "mob": "Ashtongue Feral Spirit",
    "priority": "red",
    "markers": ["skull"],
    "tags": ["focus", "tank", "ranged"],
    "danger": "Huge aggro radius. Charge Frenzy makes it charge random targets every 2 sec; Spirit Bond heals 5% HP per second.",
    "call": "PULL back; FOCUS Feral Spirit during Frenzy/Bond.",
    "tank": "Drag packs back to avoid extra aggro. Pick up random charges quickly.",
    "spells": [["Charge Frenzy", "assets/ability_warrior_charge.jpg"], ["Spirit Bond", "assets/spell_nature_healingtouch.jpg"]]
  },
  {
    "raid": "BT",
    "zone": "Akama / Sanctuary",
    "mob": "Ashtongue Mystic",
    "priority": "red",
    "markers": ["skull"],
    "tags": ["focus", "kick", "dispel", "aoe"],
    "danger": "Chain Heal is huge; Bloodlust buffs hostile attack/cast rate by 35% and is dispellable; Searing/Windfury Totems are dangerous.",
    "call": "FOCUS Mystic; KICK heals; KILL Windfury Totem.",
    "tank": "Group for cleave but call instant totem swaps, especially Windfury.",
    "spells": [["Chain Heal", "assets/spell_nature_healingtouch.jpg"], ["Bloodlust", "assets/spell_nature_bloodlust.jpg"], ["Searing Totem", "assets/spell_fire_sealoffire.jpg"], ["Summon Windfury Totem", "assets/spell_nature_elementalshields.jpg"]]
  },
  {
    "raid": "BT",
    "zone": "Akama / Sanctuary",
    "mob": "Ashtongue Primalist",
    "priority": "orange",
    "markers": ["cross"],
    "tags": ["focus", "ranged", "tank"],
    "danger": "Wyvern Sting sleeps random target; Multi-Shot hits up to 3 targets hard; Sweeping Wing Clip immobilizes nearby players for 10 sec.",
    "call": "KILL after Mystic; spread Multi-Shot.",
    "tank": "Keep away from raid stack when possible; melee watch immobilize.",
    "spells": [["Wyvern Sting", "assets/ability_hunter_pet_windserpent.jpg"], ["Multi-Shot", "assets/ability_marksmanship.jpg"], ["Sweeping Wing Clip", "assets/ability_gouge.jpg"]]
  },
  {
    "raid": "BT",
    "zone": "Akama / Sanctuary",
    "mob": "Ashtongue Stormcaller",
    "priority": "orange",
    "markers": ["triangle"],
    "tags": ["kick", "focus", "ranged"],
    "danger": "Spams Chain Lightning and Lightning Bolt; Chain Lightning initial hit is heavy and jumps.",
    "call": "KICK/FOCUS Stormcaller; spread for Chain Lightning.",
    "tank": "Caster may not move cleanly out of AoE; use LOS if needed.",
    "spells": [["Chain Lightning", "assets/spell_nature_chainlightning.jpg"], ["Lightning Bolt", "assets/spell_nature_lightning.jpg"]]
  },
  {
    "raid": "BT",
    "zone": "Akama / Sanctuary",
    "mob": "Ashtongue Stalker",
    "priority": "yellow",
    "markers": ["diamond"],
    "tags": ["dispel", "tank"],
    "danger": "Blind is a poison dispellable 10 sec disable; Mind-numbing Poison slows casting by 50%; Instant Poison adds Nature melee damage.",
    "call": "POISON dispel Blind / Mind-numbing.",
    "tank": "Expect random Blind pressure and cleanse poison fast.",
    "spells": [["Blind", "assets/ability_gouge.jpg"], ["Mind-numbing Poison", "assets/ability_creature_poison_06.jpg"], ["Instant Poison", "assets/ability_creature_poison_06.jpg"]]
  },
  {
    "raid": "BT",
    "zone": "Akama / Sanctuary",
    ...
    "markers": ["moon"],
    "tags": ["aoe", "ranged"],
    "danger": "Lightning Cloud hits then leaves a Nature ground AoE for 15 sec.",
    "call": "MOVE Lightning Cloud.",
    "tank": "Reposition pack out of cloud immediately.",
    "spells": [["Lightning Cloud", "assets/spell_nature_lightningoverload.jpg"]]
  },
  {
    "raid": "BT",
    "zone": "Akama / Sanctuary",
    "mob": "Illidari Nightlord",
    "priority": "red",
    "markers": ["skull"],
    "tags": ["fear", "tank", "focus"],
    "danger": "Patrolling enemy can be skipped; if engaged, AoE Fear can send raid into nearby packs.",
    "call": "SKIP if possible; if pulled, anti-fear and burn.",
    "tank": "Pull only in a safe spot. Fear pathing can chain-pull packs.",
    "spells": [["Fear", "assets/spell_shadow_psychicscream.jpg"]]
  },
  {
    "raid": "BT",
    "zone": "Akama / Sanctuary",
  ...
  },
  {
    "raid": "BT",
    "zone": "Teron path",
    "mob": "Shadowmoon Champion",
    "priority": "orange",
    "markers": ["skull"],
    "tags": ["tank", "cleave", "aoe"],
    "danger": "Chaotic Light is a nasty frontal cone; Whirling Blade creates a stationary Whirlwind hazard.",
    "call": "FACE Champion away; dodge spinning blade.",
    "tank": "Keep frontal off raid and do not park melee in Whirling Blade.",
    "spells": [["Chaotic Light", "assets/spell_shadow_shadowbolt.jpg"], ["Whirling Blade", "assets/ability_whirlwind.jpg"]]
  },
  {
    "raid": "BT",
    "zone": "Teron path",
    "mob": "Shadowmoon Houndmaster",
    "priority": "orange",
    "markers": ["cross"],
    "tags": ["dispel", "ranged", "tank"],
    "danger": "Freezing Trap roots players within 20 yd for 30 sec and is dispellable; Silencing Shot hits/silences random player; Wing Clip slows in melee.",
    "call": "DISPEL traps; watch random silence.",
    "tank": "Pick up Riding Hounds when Houndmaster dismounts. Keep pack away from rooted casters.",
    "spells": [["Freezing Trap", "assets/spell_frost_frostnova.jpg"], ["Silencing Shot", "assets/spell_holy_silence.jpg"], ["Wing Clip", "assets/ability_gouge.jpg"]]
  },
  {
    "raid": "BT",
    "zone": "Teron path",
    "mob": "Shadowmoon Riding Hound",
    "priority": "yellow",
    "markers": ["diamond"],
    "tags": ["tank", "aoe"],
    "danger": "Summoned hounds apply Carnivorous Bite bleed.",
    "call": "Pick up hounds; cleave.",
    "tank": "Grab hounds immediately when they appear from Houndmasters.",
    "spells": [["Carnivorous Bite", "assets/ability_druid_ferociousbite.jpg"]]
  },
  {
    "raid": "BT",
    "zone": "Teron path",
    "mob": "Shadowmoon Reaver",
    "priority": "orange",
    "markers": ["triangle"],
    "tags": ["ranged", "tank"],
    "danger": "Spell Absorption absorbs magic effects and builds Chaotic Charges that detonate when the buff ends.",
    "call": "STOP feeding Spell Absorption.",
    "tank": "Warn casters not to pump into absorption; stabilize before detonation.",
    "spells": [["Spell Absorption", "assets/spell_arcane_arcanepotency.jpg"]]
  },
  {
    "raid": "BT",
    "zone": "Teron path",
  ...
  },
  {
    "raid": "BT",
    "zone": "Before Gurtogg",
    "mob": "Bonechewer Brawler",
    "priority": "yellow",
    "markers": ["triangle"],
    "tags": ["tank"],
    "danger": "Large melee mob; Frenzy doubles attack rate for 8 sec.",
    "call": "Watch Frenzy; burn with pack.",
    "tank": "Mitigate during Frenzy windows.",
    "spells": [["Frenzy", "assets/spell_shadow_unholyfrenzy.jpg"]]
  },
  {
    "raid": "BT",
    "zone": "Before Gurtogg",
    "mob": "Bonechewer Combatant",
    "priority": "green",
    "markers": ["square"],
    "tags": ["aoe"],
    "danger": "Weak melee attacker with no listed abilities.",
    "call": "AoE filler.",
    "tank": "Gather with pack.",
    "spells": []
  },
  {
    "raid": "BT",
    "zone": "Before Gurtogg",
    "mob": "Bonechewer Spectator",
    "priority": "green",
    "markers": ["diamond"],
    "tags": ["aoe"],
  ...
  },
  {
    ...
    "markers": ["diamond"],
    "tags": ["dispel", "ranged"],
    "danger": "Curse of Vitality is a Shadow DoT removed if player drops below 50% health.",
    "call": "Decurse / heal Woe targets.",
    "tank": "Keep controlled with Mother approach packs.",
    "spells": [["Curse of Vitality", "assets/spell_shadow_cripple.jpg"]]
  },
  {
    "raid": "BT",
    "zone": "Before Mother Shahraz",
